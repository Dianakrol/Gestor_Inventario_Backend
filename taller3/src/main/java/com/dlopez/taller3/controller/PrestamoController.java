...
import com.dlopez.taller3.service.PrestamoService;
...
public class PrestamoController {
    ...
    @PostMapping
    public Prestamo createLoan(@RequestBody Prestamo prestamo) {
        return prestamoService.createLoan(prestamo);
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Prestamo> updateLoanFromDTO(@PathVariable Long id, @RequestBody Prestamo prestamoDetails) {
        return ResponseEntity.ok(prestamoService.updateLoan(id, prestamoDetails));
    }
